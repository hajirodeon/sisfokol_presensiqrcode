			    ...
			    if ($i > 1) 
			    	{
					  ...
					  $i_qrcode = "$kdepan$i_kode";
						...
						if (!empty($tcc))
							...
							{
							//insert
							mysql_query("INSERT INTO m_orang(kd, kode, nama, jabatan, qrcode, postdate) VALUES ".
...
if ($_POST['btnSMP'])
	...
	if ((empty($e_nip)) OR (empty($e_nama)) OR (empty($e_jabatan)))
		...
		if ($s == "edit")
			{
			mysql_query("UPDATE m_orang SET kode = '$e_nip', ".
							"nama = '$e_nama', ".
							"jabatan = '$e_jabatan' ".
							"WHERE kd = '$kd'");
	...
	if ($count != 0)
		...
		do 
			...
			if (empty($i_kode))
				...
				//update...
				mysql_query("UPDATE m_orang SET kode = '$kodenya', ".
								"qrcode = '$kodenya' ".
								"WHERE kd = '$i_kd'");
				}
